...
export const Footer = () => {
  return (
    <div className="bg-[url('/home/footer.svg')]">
      <div className="bg-center bg-cover md:min-h-[15.375rem] max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col gap-[2rem] md:gap-0 md:flex-row md:items-center md:justify-between py-[5rem] md:py-0">

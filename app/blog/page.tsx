      ...
      <div className="bg-[linear-gradient(#fff,_#fff5ed)] px-[2rem] md:px-lr-custom py-[4rem] md:py-[7.5rem]">
        ...
        <div className="mt-[3rem] md:mt-[5rem] flex flex-col md:flex-row flex-wrap gap-[1.5rem]">
          {products.map((product: Products) => (
            <div
              key={product.id}
              className="min-h-[32rem] p-[1.5rem] bg-[linear-gradient(#fff5ed,_#f9e3d0)] shadow-md rounded-[0.5rem] flex flex-col gap-[1rem] box-border"
            ...
            >
              ...
              ></div>
              <h1 className="text-[var(--color-three)] text-[0.9rem] md:text-[1rem] font-semibold mt-[1rem]">
                {product.date}
              </h1>
              <p className="text-[1.4rem] text-[var(--color-one)] font-semibold">
                {product.content}
              </p>

    ...
    <div>
      ...
      <div className="px-[2rem] lg:px-lr-custom flex flex-col md:flex-row py-[4rem] md:py-[10rem]">
        ...
        >
          ...
          <p className="text-[1.75rem] md:text-[3rem] text-[var(--color-two)] leading-normal font-bold md:leading-[3.5rem]">
            This is Awkward. We Can&apos;t Find That Page.
          </p>
          <p className="text-[1.125rem] text-[var(--color-four)]">
            Netus et malesuada fames ac turpis. Rhoncus urna neque viverra justo
            nec ultrices enim diam vulputate
          </p>
          <Link
            href="/"
            className="bg-[var(--color-three)] flex px-[2rem] rounded-[50vw] items-center justify-center gap-[1rem] py-[0.8rem] text-[var(--color-white)] hover:bg-[var(--color-two)] [transition:background_0.3s] text-[1.125rem] font-medium  self-start"
          >
            Back to Home
          </Link>
        </div>
        <div
          style={{ flexBasis: "calc(60% - 20px)" }}
